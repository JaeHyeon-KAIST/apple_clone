(() => {
  ...
  let prevScrollHeight = 0; // 현재 스크롤 위치(yOffset)보다 이전에 위치한 스크롤 색션들의 스크롤 높이갚의 합
    ...
    switch (currentScene) {
      ...
      case 2:
        ...
        if (scrollRatio > 0.9) {
          ...
          const recalcuatedInnerWidth = document.body.offsetWidth / canvasScaleRatio;

          const whiteRectWidth = recalcuatedInnerWidth * 0.15;
          values.rect1X[0] = (objs.canvas.width - recalcuatedInnerWidth) / 2;
          values.rect1X[1] = values.rect1X[0] - whiteRectWidth;
          values.rect2X[0] = values.rect1X[0] + recalcuatedInnerWidth - whiteRectWidth;
  ...
  function loop() {
    ...
    if (Math.abs(yOffset - delayedYOffset) < 10) {
